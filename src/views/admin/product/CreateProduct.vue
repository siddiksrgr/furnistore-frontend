      ...
      <div class="row">
        ...
        <main class="col-md-9 ml-sm-auto col-lg-10 p-4">
          ...
          <form @submit.prevent="submit" enctype="multipart/form-data">
            <div class="card">
              <div class="card-header">Form Create New Product</div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group mb-3">
                      <label class="form-label fw-bold" for="name">Name</label>
                      <input type="text" class="form-control" id="name" placeholder="Enter product name" v-model="name" />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group mb-3">
                      <label class="form-label fw-bold" for="stock">Stock</label>
                      <input type="number" class="form-control" id="stock" placeholder="Enter product stock" v-model="stock" />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group mb-3">
                      <label class="form-label fw-bold" for="price">Price</label>
                      <input type="number" class="form-control" id="price" placeholder="Enter product price" v-model="price" />
                    </div>
                  </div>
                </div>
                <div class="form-group mb-3">
                  <label class="form-label fw-bold" for="images">Images</label>
                ...
                <div class="form-group mb-3">
                  ...
                  <!-- <textarea class="form-control" id="description" rows="3" v-model="descriptions"></textarea> -->
                  <ckeditor id="descriptions" :editor="editor" v-model="descriptions"></ckeditor>
                </div>
              </div>
    ...
    submit() {
      ...
      axios
        .post(
          ...
          { name, stock, price, images, descriptions },
          {
            headers: {
